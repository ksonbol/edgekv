...
for i in 1..NUM_GROUPS
    ...
    Distem.client do |dis|
        for j in 1..NUM_SRVR_PER_GROUP
            ...
            addr = dis.viface_info(n,'if1')['address'].split('/')[0] # if1 for etcd-etcd comm
    ...
    sleep(3) # make sure previous etcd instances are killed
    ...
    puts "started etcd instances in edge group #{i}"
    sleep(5) # make sure etcd instances are running and have stabilized
    Distem.client do |dis|
...
puts "all etcd clusters have been setup"