...
func main() {
	...
	cli.Put("k", utils.LocalDataStr, "local")
	cli.Put("k2", utils.LocalDataStr, "local2")
	cli.Put("k3", utils.LocalDataStr, "local3")
	fmt.Println("First group should have local key 'k' while second and third wouldn't")
	fmt.Println(cli.Get("k", utils.LocalDataStr))
	fmt.Println(cli2.Get("k", utils.LocalDataStr))
	fmt.Println(cli3.Get("k", utils.LocalDataStr))
	...
	fmt.Println(cli.Get("k", utils.GlobalDataStr))
	fmt.Println(cli2.Get("k", utils.GlobalDataStr))
	fmt.Println(cli3.Get("k", utils.GlobalDataStr))
	...
	fmt.Println(cli2.Put("k3", utils.GlobalDataStr, "global3"))
	fmt.Println(cli2.Put("k4", utils.GlobalDataStr, "global4"))
	fmt.Println(cli3.Put("k5", utils.GlobalDataStr, "global5"))
	fmt.Println(cli3.Put("k6", utils.GlobalDataStr, "global6"))
	fmt.Println("Showing key-value pairs of each edge group")
	fmt.Println(cli.Get("k6", utils.GlobalDataStr))
	fmt.Println(cli2.Get("k", utils.GlobalDataStr))
	fmt.Println(cli3.Get("k4", utils.GlobalDataStr))
